...
def generate_custom_interface(laser_off_command, laser_power_command, laser_off_delay, laser_power_delay):
...
class GcodeExtension(EffectExtension):
    ...
    def effect(self):
        ...
        custom_interface = generate_custom_interface(self.options.tool_off_command, self.options.tool_power_command, self.options.tool_off_delay, self.options.tool_power_delay)
